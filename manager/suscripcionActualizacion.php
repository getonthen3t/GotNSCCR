				   ...
				   <div class="six columns noleftmargin">
                                    ...
                                    <div class="six columns noleftmargin">
                                        ...
                                        <div id="divNumeroIdentificacion">
                                            <input type="text" maxlength="9" minlength="9" name="vIdentificacion" required class="smoothborder" placeholder="No dígite espacios ni guiones*" title="Debe ingresar su Identificación" required/>
                                        </div>
                                    </div>
                                    <div class="six columns noleftmargin">
					<label>Nombre</label>
					<input type="text" name="vNombre" class="smoothborder" required  placeholder="Nombre *" title="Debe ingresar su Nombre" required/>
					</div>
                                    <div class="six columns noleftmargin">
					<label>Primer apellido</label>
					<input type="text" name="vApellido1"  class="smoothborder" required placeholder="Primer apellido*" title="Debe ingresar su Apellido" required/>
					</div>
                                    <div class="six columns noleftmargin">
					<label>Segundo apellido</label>
                                        <input type="text" name="vApellido2" class="smoothborder" required placeholder="Segundo apellido *" title="Debe ingresar su Apellido" />
					</div>
					<div class="six columns noleftmargin">
					<label>E-mail </label>
					<input type="email" name="vEmail" required class="smoothborder" placeholder="Dirección de correo electrónico*" title="Debe ingresar su correo electronico" required/>
					</div>
                                    <div class="six columns noleftmargin">
                                        <label>Tel&eacute;fono Casa</label>
					<input type="number" name="vTel" required class="smoothborder" placeholder="Teléfono*" title="Debe ingresar su Telefono"/>
					</div>
                                    <div class="six columns noleftmargin">
                                        <label>Tel&eacute;fono Celular </label>
					<input type="number" name="vTel2" required class="smoothborder" placeholder="Teléfono*" title="Debe ingresar su Telefono" required/>
					</div>
                                    
                                    <div class="six columns noleftmargin">
					<label>Provincia </label>
                                       
                                        <select id="vProvincia" name="vProvincia" type="text" onchange="cambiaCanton();">
                                 ...
                                 <div class="six columns noleftmargin" >
                                        <label>Cantón </label>
                                        <div id="divCanton">
                                            <select type="text" name="vCanton" id="vCanton" onchange="cambiaDistrito();" >
                                   ...
                                   <div class="six columns noleftmargin"> 
                                    ...
                                    <textarea required="true" name="vDireccion" id="vDireccion" class="smoothborder ctextarea" rows="5" placeholder="Dirección física, lugar en el cual se le entregaran los pedidos *" title="Debe ingresar su dirección exacta" required></textarea>
				</div>
                                    <input type="submit"  class="readmore" value="Registrar" name="Registrar" >

    ...
    public function alertas($cantidadCasilleros) {
        ...
        try {
            if ($cantidadCasilleros == 0) {
                echo '<li><a href="casillerosPendient.php">Casilleros pendientes<span class="label label-success">' . $cantidadCasilleros . '</span></a></li>';
            } else if ($cantidadCasilleros <= 5) {
                echo '<li><a href="casillerosPendient.php">Casilleros pendientes<span class="label label-warning">' . $cantidadCasilleros . '</span></a></li>';
            } else if ($cantidadCasilleros >= 6) {
                echo '<li><a href="casillerosPendient.php">Casilleros pendientes<span class="label label-danger">' . $cantidadCasilleros . '</span></a></li>';
            }
        } catch (PDOException $e) {
            echo $e->getMessage();
        }
